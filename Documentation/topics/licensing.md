...
This legacy licensing option is only available for applications that target the classic .NET Framework and is what Actipro exclusively used prior to v21.1.
...
```
ActiproSoftware.Licensing.ActiproLicenseToken, ActiproSoftware.Shared.WinForms, Version=26.1.1.0, Culture=neutral, PublicKeyToken=c27e062d3c1a4763
```

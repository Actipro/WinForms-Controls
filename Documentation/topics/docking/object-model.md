...
A container for a dock container is represented by the [DockContainerContainer](xref:@ActiproUIRoot.Controls.Docking.DockContainerContainer) class.  It is used as a container for other dock containers which can include tool window containers and dock container containers.

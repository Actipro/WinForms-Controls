...
To simplify working with reference type properties on instances of [IUIRenderer](xref:@ActiproUIRoot.Controls.IUIRenderer) (such as [BackgroundFill](xref:@ActiproUIRoot.Drawing.BackgroundFill), [Border](xref:@ActiproUIRoot.Drawing.Border), or `Font`), all properties for reference types will be nullable even if the default value is not `null`.
...
Any custom implementations of a [IUIRenderer](xref:@ActiproUIRoot.Controls.IUIRenderer) should be updated to handle possible `null` references to any [BackgroundFill](xref:@ActiproUIRoot.Drawing.BackgroundFill), [Border](xref:@ActiproUIRoot.Drawing.Border), or `Font` property values.
...
The [ObservableObjectBase](xref:ActiproSoftware.ObservableObjectBase) class was moved from its previous namespace `ActiproSoftware.UI.WinForms` to the Core library in the `ActiproSoftware` namespace.  The class now implements both the `IPropertyChanging` and `IPropertyChanged` interfaces.
...
The [DisposableObjectBase](xref:ActiproSoftware.DisposableObjectBase) class was renamed from `DisposableObject` in its previous namespace `ActiproSoftware.Text.Utility` and moved to the Core library in the `ActiproSoftware` namespace.  Its [Dispose](xref:ActiproSoftware.DisposableObjectBase.Dispose*) method is now `abstract` instead of being `virtual` with an empty implementation.

The Shared library's former `DisposableObject` class was renamed to [MarshalByRefDisposableObject](xref:@ActiproUIRoot.MarshalByRefDisposableObject), since that class inherited `MarshalByRefObject`.

> [!TIP]
> Migrate any prior `DisposableObject` usage to the [DisposableObjectBase](xref:ActiproSoftware.DisposableObjectBase) class in the Core library.

### DoubleExtensions Migrated

The [DoubleExtensions](xref:ActiproSoftware.Extensions.DoubleExtensions) class from moved from its previous `ActiproSoftware.UI.WinForms.Extensions` namespace to the Core library in the `ActiproSoftware.Extensions` namespace.
...
New functionality was added in this release to support a [Menu Factory](../shared/menu-factory.md) for generating contextual menus.  In order to support this functionality, the following breaking changes were necessary:

- Docking class [TabbedMdiWindowContextMenuEventArgs](xref:@ActiproUIRoot.Controls.Docking.TabbedMdiWindowContextMenuEventArgs).[DefaultContextMenu](xref:@ActiproUIRoot.Controls.Docking.TabbedMdiWindowContextMenuEventArgs.DefaultContextMenu) value type changed to [IMenu](xref:@ActiproUIRoot.Controls.IMenu).
- [SyntaxEditor](xref:@ActiproUIRoot.Controls.SyntaxEditor.SyntaxEditor).[CreateDefaultContextMenu](xref:@ActiproUIRoot.Controls.SyntaxEditor.SyntaxEditor.CreateDefaultContextMenu*) virtual method return type changed to [IMenu](xref:@ActiproUIRoot.Controls.IMenu).
- [SyntaxEditorMenuEventArgs](xref:@ActiproUIRoot.Controls.SyntaxEditor.SyntaxEditorMenuEventArgs).[Menu](xref:@ActiproUIRoot.Controls.SyntaxEditor.SyntaxEditorMenuEventArgs.Menu) value type changed to [IMenu](xref:@ActiproUIRoot.Controls.IMenu).

To facilitate working with native WinForms menu controls, the [MenuFactory](xref:@ActiproUIRoot.Controls.MenuFactory).[WrapMenu](xref:@ActiproUIRoot.Controls.MenuFactory.WrapMenu*) method can be used to wrap a `ContextMenuStrip` in a class that implements the [IMenu](xref:@ActiproUIRoot.Controls.IMenu) interface.  The [WrapMenuItem](xref:@ActiproUIRoot.Controls.MenuFactory.WrapMenuItem*) and [WrapMenuSeparator](xref:@ActiproUIRoot.Controls.MenuFactory.WrapMenuSeparator*) methods are also available for `ToolStripMenuItem` and `ToolStripSeparator`, respectively.

Alternatively, any menu customization can be rewritten to use the current menu factory.  See the [Menu Factory](../shared/menu-factory.md) topic for additional details.
...
- [NavigationPaneCollection](xref:@ActiproUIRoot.Controls.Navigation.NavigationPaneCollection) (Navigation Library)
- [TabStripPageCollection](xref:@ActiproUIRoot.Controls.Docking.TabStripPageCollection) (Docking Library)
- [WizardPageCollection](xref:@ActiproUIRoot.Controls.Wizard.WizardPageCollection) (Wizard Library)
...
- [BarCommandCollection](xref:@ActiproUIRoot.Controls.Bars.BarCommandCollection)
- [BarKeyboardShortcutCollection](xref:@ActiproUIRoot.Controls.Bars.BarKeyboardShortcutCollection)
- [BarManagerDockableToolBarCollection](xref:@ActiproUIRoot.Controls.Bars.BarManagerDockableToolBarCollection)
- [BarModeCollection](xref:@ActiproUIRoot.Controls.Bars.BarModeCollection)
- [PopupMenuCollection](xref:@ActiproUIRoot.Controls.Bars.PopupMenuCollection)
...
- The `ToArray` method was removed (applies to [BarManagerDockableToolBarCollection](xref:@ActiproUIRoot.Controls.Bars.BarManagerDockableToolBarCollection) and [BarModeCollection](xref:@ActiproUIRoot.Controls.Bars.BarModeCollection) only).  Use the LINQ extension method instead, which requires importing the `System.Linq` namespace.
...
- [DockContainerCollection](xref:@ActiproUIRoot.Controls.Docking.DockContainerCollection)
- [DocumentWindowCollection](xref:@ActiproUIRoot.Controls.Docking.DocumentWindowCollection)
- [TabbedMdiContainerCollection](xref:@ActiproUIRoot.Controls.Docking.TabbedMdiContainerCollection)
- [TabbedMdiWindowCollection](xref:@ActiproUIRoot.Controls.Docking.TabbedMdiWindowCollection)
- [ToolWindowCollection](xref:@ActiproUIRoot.Controls.Docking.ToolWindowCollection)
...
- [BarLayoutXmlSerializer](xref:@ActiproUIRoot.Controls.Bars.BarLayoutXmlSerializer)
  - `ThrowException` method renamed to [CreateException](xref:@ActiproUIRoot.Controls.Bars.BarLayoutXmlSerializer.CreateException*) and returns an `Exception` to be thrown by the caller.
  - `ThrowUnrecognizedTagException` method renamed to [CreateUnrecognizedTagException](xref:@ActiproUIRoot.Controls.Bars.BarLayoutXmlSerializer.CreateUnrecognizedTagException*) and returns an `Exception` to be thrown by the caller.
- [KeysCollection](xref:@ActiproUIRoot.Controls.Bars.KeysCollection) base type changed from `CollectionBase` to `Collection<Keys>`, which results in the following additional changes:
...
- [ILogicalTreeNode](xref:@ActiproUIRoot.ILogicalTreeNode).[Children](xref:@ActiproUIRoot.ILogicalTreeNode.Children) property type changed from `IList` to `IList<ILogicalTreeNode>`.
- [LogicalTreeNodeBase](xref:@ActiproUIRoot.LogicalTreeNodeBase).[CreateChildren](xref:@ActiproUIRoot.LogicalTreeNodeBase.CreateChildren*) virtual method return type changed from `IList` to `IList<ILogicalTreeNode>`.
- [LogicalTreeNodeCollection](xref:@ActiproUIRoot.LogicalTreeNodeCollection) updated to support generics.
  - Implemented interface changed from `IList` to `IList<ILogicalTreeNode>`.
  - [CopyTo](xref:@ActiproUIRoot.LogicalTreeNodeCollection.CopyTo*) array parameter value type changed from `Array` to `ILogicalTreeNode[]`.
  - [GetEnumerator](xref:@ActiproUIRoot.LogicalTreeNodeCollection.GetEnumerator*) return type changed from `IEnumerator` to `IEnumerator<ILogicalTreeNode>` and is no longer `virtual`.
...
- [Border](xref:@ActiproUIRoot.Drawing.Border).[GetInnerBounds](xref:@ActiproUIRoot.Drawing.Border.GetInnerBounds*) overload that did not accept a [Sides](xref:@ActiproUIRoot.Drawing.Sides) argument has been removed and the other overload has been updated to default to [Sides](xref:@ActiproUIRoot.Drawing.Sides).[All](xref:@ActiproUIRoot.Drawing.Sides.All).  Method calls are not impacted by this change, but derived classes that had an override for either virtual method will need to be updated to match the new base methods.
- [MarkupLabelElement](xref:@ActiproUIRoot.Controls.MarkupLabel.MarkupLabelElement)
  - [Children](xref:@ActiproUIRoot.Controls.MarkupLabel.MarkupLabelElement.Children) property type changed from `IList` to `IList<ILogicalTreeNode>`.
  - [Parent](xref:@ActiproUIRoot.Controls.MarkupLabel.MarkupLabelElement.Parent) property setter access changed from `public` to `internal` since it is for internal use only.
- [UIControl](xref:@ActiproUIRoot.Controls.Primitives.UIControl) updated to support changes in [ILogicalTreeNode](xref:@ActiproUIRoot.ILogicalTreeNode).
  - [CreateChildren](xref:@ActiproUIRoot.Controls.Primitives.UIControl.CreateChildren*) return type changed from `IList` to `IList<ILogicalTreeNode>`.

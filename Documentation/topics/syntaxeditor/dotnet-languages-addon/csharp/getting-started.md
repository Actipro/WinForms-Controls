...
| ActiproSoftware.Text.Addons.DotNet.WinForms.dll | Yes | Actipro | .NET Languages Add-on | Core text/parsing for the C# language |
| ActiproSoftware.SyntaxEditor.Addons.DotNet.WinForms.dll | Yes | Actipro | .NET Languages Add-on | SyntaxEditor for WinForms advanced C# syntax language implementation |

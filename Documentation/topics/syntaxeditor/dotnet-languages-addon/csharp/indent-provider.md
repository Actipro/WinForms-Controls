...
The [CSharpIndentProvider](xref:ActiproSoftware.Text.Languages.CSharp.Implementation.CSharpIndentProvider) class is the default implementation of an [IIndentProvider](xref:ActiproSoftware.UI.WinForms.Controls.SyntaxEditor.IIndentProvider) service for this language.

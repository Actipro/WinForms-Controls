...
public partial class MainControl : UserControl {
	...
	public MainControl() {
		...
		editor.Document.UndoHistory.UndoStack.StackChanged += OnSyntaxEditorDocumentUndoStackChanged;
		editor.Document.UndoHistory.RedoStack.StackChanged += OnSyntaxEditorDocumentRedoStackChanged;
	}
	...
	private static void SyncUndoableTextChangeStackToListbox(IUndoableTextChangeStack stack, ListBox listBox) {
		listBox.Items.Clear();

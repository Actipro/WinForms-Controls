...
public class CustomMargin : EditorViewMarginBase {
	...
	public CustomMargin(IEditorView view, EditorViewMarginPlacement placement)
	...
	public override void Draw(TextViewDrawContext context) {
		...
		using var layout = context.Canvas.CreateTextLayout("Margin placement: " + Placement, bounds.Width - (20 * context.DpiScale), "Segoe UI", 8, SystemColors.ControlText);

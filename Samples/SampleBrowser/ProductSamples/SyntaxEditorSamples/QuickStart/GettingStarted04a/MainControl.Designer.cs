namespace ActiproSoftware.ProductSamples.SyntaxEditorSamples.QuickStart.GettingStarted04a {
	partial class MainControl {
		...
		private void InitializeComponent() {
			...
			this.ebnfToolWindow = new ActiproSoftware.UI.WinForms.Controls.Docking.ToolWindow();
			this.ebnfEditor = new ActiproSoftware.UI.WinForms.Controls.SyntaxEditor.SyntaxEditor();
			...
			this.ebnfToolWindow.SuspendLayout();
			...
			this.astOutputToolWindow.Size = new System.Drawing.Size(198, 545);
			...
			this.astOutputEditor.Size = new System.Drawing.Size(198, 545);
			...
			this.toolWindowContainer1.Size = new System.Drawing.Size(206, 588);
			this.toolWindowContainer1.TabIndex = 9;
			toolWindowContainer1.Controls.Add(astOutputToolWindow);
			toolWindowContainer1.Controls.Add(ebnfToolWindow);
			// 
			// ebnfToolWindow
			// 
			this.ebnfToolWindow.Controls.Add(this.ebnfEditor);
			this.ebnfToolWindow.Dock = System.Windows.Forms.DockStyle.Fill;
			this.ebnfToolWindow.DockManager = this.dockManager;
			this.ebnfToolWindow.Location = new System.Drawing.Point(0, 0);
			this.ebnfToolWindow.Name = "ebnfToolWindow";
			this.ebnfToolWindow.Size = new System.Drawing.Size(198, 545);
			this.ebnfToolWindow.TabIndex = 0;
			this.ebnfToolWindow.Text = "EBNF";
			// 
			// ebnfEditor
			// 
			this.ebnfEditor.AllowDrop = true;
			this.ebnfEditor.BorderStyle = System.Windows.Forms.BorderStyle.None;
			this.ebnfEditor.CanSplitHorizontally = false;
			this.ebnfEditor.Dock = System.Windows.Forms.DockStyle.Fill;
			this.ebnfEditor.Document.IsReadOnly = true;
			this.ebnfEditor.IsOutliningMarginVisible = false;
			this.ebnfEditor.IsSelectionMarginVisible = false;
			this.ebnfEditor.Location = new System.Drawing.Point(0, 0);
			this.ebnfEditor.Name = "ebnfEditor";
			this.ebnfEditor.Size = new System.Drawing.Size(198, 545);
			this.ebnfEditor.TabIndex = 1;
			// 
			// errorToolWindow
			// 
			...
			this.ebnfToolWindow.ResumeLayout(false);
		...
		private ActiproSoftware.UI.WinForms.Controls.Docking.ToolWindow ebnfToolWindow;
		...
		private UI.WinForms.Controls.SyntaxEditor.SyntaxEditor ebnfEditor;
	}
}

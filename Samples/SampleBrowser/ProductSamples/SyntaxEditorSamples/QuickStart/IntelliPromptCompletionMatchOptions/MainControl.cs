...
namespace ActiproSoftware.ProductSamples.SyntaxEditorSamples.QuickStart.IntelliPromptCompletionMatchOptions {
	...
	public partial class MainControl : UserControl {
		...
		private void UpdateCompletionProviderOptions() {
			...
			provider.IsCaseSensitive = isCaseSensitiveCheckBox.Checked;
			provider.RequiresExact = requiresExactCheckBox.Checked;
			provider.UseAcronyms = useAcronymsCheckBox.Checked;
			provider.UseShorthand = useShorthandCheckBox.Checked;
			provider.CanHighlightMatchedText = highlightMatchesCheckBox.Checked;
		}

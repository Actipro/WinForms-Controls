...
public class CustomMargin : PrinterViewMarginBase {
	...
	public CustomMargin(IPrinterView view, PrinterViewMarginPlacement placement)
		: base(view, "Custom", placement, [
	...
	public override void Draw(TextViewDrawContext context) {
		...
		using (var layout = context.Canvas.CreateTextLayout("Margin placement: " + Placement, bounds.Width - 20, "Segoe UI", 8, SystemColors.ControlText)) {
	...
	protected override Size MeasureOverride(Graphics? g, Size availableSize) {
		...
		switch (Placement) {
			case PrinterViewMarginPlacement.Bottom:
			case PrinterViewMarginPlacement.Top:
				return new Size(availableSize.Width, (int)(20 * scaleFactor.Height));
			default:
				return new Size((int)(80 * scaleFactor.Width), availableSize.Height);
		}
	}

...
|---|---|
| Commercial Actipro WinForms Controls | Yes (current major version and any active LTS versions) |
...
Public security advisories for Actipro WinForms Controls are published only in the Security section of this public repository. Actipro does not maintain a separate mechanism for directly notifying third parties through other channels.
